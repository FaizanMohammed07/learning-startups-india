  ...
  return (
    <button
      ...
      className={`relative flex items-center gap-1.5 px-5 py-2.5 text-sm font-semibold rounded-xl transition-all duration-200 whitespace-nowrap ${
        active ? 'text-white' : 'text-gray-500 hover:text-[#7A1F2B] hover:bg-[#7A1F2B]/5'
      }`}
    >
      {active && (
        <motion.div
...
export default function CourseDetailPage() {
  ...
  const discountPercent = hasDiscount
    ? Math.round(((course.originalPriceInr - price) / course.originalPriceInr) * 100)
    : 0;
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-5 gap-y-3 text-sm text-white/50">
                ...
                {course.durationWeeks > 0 && (
                  <span className="flex items-center gap-1.5">
                    <span className="text-[#C5975B]">{Icons.clock}</span> {course.durationWeeks}{' '}
                    Weeks
                  </span>
                )}
                ...
                <div className="p-6">
                  ...
                  {hasDiscount && (
                    <p className="text-sm text-emerald-600 font-medium mb-4 flex items-center gap-1">
                      <span className="text-emerald-500">{Icons.money}</span> {discountPercent}%
                      discount applied
                    </p>
                  )}
                  ...
                  {!enrolled && (
                    ...
                    >
                      {wishlisted ? (
                        <>
                          <span className="text-red-500">{Icons.heartFill}</span> In Wishlist
                        </>
                      ) : (
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      {(course.whatYouLearn || modules.slice(0, 8).map(m => m.title)).map(
                        (item, i) => (
                          <motion.div
                            key={i}
                            initial={{ opacity: 0, x: -10 }}
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-xl bg-[#7A1F2B]/10 flex items-center justify-center text-[#7A1F2B]">
                        {Icons.book}
                      </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {[
                      ...
                      <div
                        key={i}
                        className="bg-white rounded-2xl border border-gray-100 p-5 text-center shadow-sm hover:shadow-md transition-shadow"
                      >
                        <div
                          className={`w-10 h-10 mx-auto rounded-xl ${stat.bg} flex items-center justify-center ${stat.color} mb-3`}
                        >
                          {stat.icon}
                        </div>
                      ...
                      {[
                        {
                          ...
                          desc: 'Content designed with top startup founders and investors',
                        },
                        {
                          icon: Icons.mentor,
                          title: 'Expert Mentorship',
                          desc: 'Direct guidance from experienced industry professionals',
                        },
                        {
                          icon: Icons.globe,
                          title: 'Global Community',
                          desc: 'Connect with entrepreneurs from across India and beyond',
                        },
                        {
                          icon: Icons.certificate,
                          title: 'Recognized Certification',
                          desc: 'Get a certificate valued by startups and investors alike',
                        },
                      ].map((card, i) => (
                        <motion.div
                          key={i}
                  ...
                  <div className="lg:hidden bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                    ...
                    {enrolled ? (
                      <Link
                        href={`/learn/${course._id}`}
                        className="flex items-center justify-center gap-2 w-full py-3.5 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition"
                      >
                        Continue Learning {Icons.arrow}
                      </Link>
                    ) : (
                ...
                >
                  <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <button
                        onClick={() => {
                          ...
                          setExpandedModule(expandAll ? null : 'all');
                        }}
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-1.5 mb-6">
                      <div
                        className="bg-gradient-to-r from-[#7A1F2B] to-[#C5975B] h-1.5 rounded-full"
                        style={{ width: enrolled ? '100%' : '0%' }}
                      />
                    </div>
                            ...
                            <button
                              onClick={() => {
                                if (expandAll) {
                                  setExpandAll(false);
                                  setExpandedModule(i);
                                } else setExpandedModule(expandedModule === i ? null : i);
                              }}
              ...
              {activeTab === 'benefits' && (
                ...
                >
                  <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 rounded-xl bg-[#C5975B]/10 flex items-center justify-center text-[#C5975B]">
                        {Icons.trophy}
                      </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {[
                        ...
                        >
                          <div
                            className={`w-10 h-10 shrink-0 rounded-xl ${b.bg} flex items-center justify-center ${b.color} group-hover:scale-110 transition-transform`}
                          >
                            {b.icon}
                          </div>
                          <div>
                ...
                >
                  <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                    ...
                    <div className="space-y-0">
                      {[
                        ...
                        },
                        {
                          ...
                          a: 'We offer a 7-day money-back guarantee. If you are not satisfied, contact us within 7 days of enrollment.',
                        },
                        {
                          q: 'Do I need prior experience?',
                          a: 'No prior experience is required. The course is designed for beginners and intermediate learners alike.',
                        },
                        {
                          q: 'How long do I have access?',
                          a: 'You get lifetime access. Learn at your own pace, revisit materials anytime.',
                        },
                      ].map((faq, i) => (
                        <details key={i} className="group border-b border-gray-100 last:border-0">
                          <summary className="flex items-center gap-3 py-4 cursor-pointer hover:text-[#7A1F2B] transition-colors">
                            <span className="w-7 h-7 shrink-0 rounded-lg bg-[#7A1F2B]/8 flex items-center justify-center text-xs font-bold text-[#7A1F2B]">
                              {i + 1}
                            </span>
                            <span className="flex-1 text-sm font-semibold text-gray-700 group-hover:text-[#7A1F2B]">
                              {faq.q}
                            </span>
                          ...
                          <p className="pb-4 pl-10 text-sm text-gray-500 leading-relaxed">
                            {faq.a}
                          </p>
                        </details>
                      ))}
                    ...
                    <div className="mt-6 p-4 bg-[#faf8f5] rounded-xl flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#C5975B]/10 flex items-center justify-center text-[#C5975B] shrink-0">
                        {Icons.mentor}
                      </div>
                      <div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                    ...
                    <div className="bg-[#faf8f5] rounded-xl p-6 flex flex-col sm:flex-row items-center gap-6 mb-8">
                      <div className="text-center">
                        ...
                        <div className="flex text-[#C5975B] mt-2 justify-center">
                          {[1, 2, 3, 4, 5].map(i => (
                            <span key={i}>{Icons.star}</span>
                          ))}
                        </div>
                        ...
                        {[
                          ...
                          <div key={bar.stars} className="flex items-center gap-3">
                            ...
                            <div className="flex-1 bg-gray-200 rounded-full h-2 overflow-hidden">
                              <motion.div
                                className="h-full bg-gradient-to-r from-[#C5975B] to-[#7A1F2B] rounded-full"
                                initial={{ width: 0 }}
                    ...
                    <div className="text-center py-8">
                      <div className="w-16 h-16 mx-auto rounded-2xl bg-[#C5975B]/10 flex items-center justify-center text-[#C5975B] mb-4">
                        {Icons.mentor}
                      </div>
                      ...
                      <p className="text-gray-500 text-sm max-w-md mx-auto">
                        Student reviews will appear here as enrollments grow. Be among the first to
                        take this course and share your experience.
                      </p>
                    </div>
                  </div>
                </motion.div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="px-10 py-4 bg-white text-[#7A1F2B] rounded-xl font-bold text-base shadow-xl hover:shadow-2xl transition-shadow disabled:opacity-50"
                >
                  {enrolling
                    ? 'Processing...'
                    : price > 0
