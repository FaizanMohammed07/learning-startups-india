  ...
  return (
    <div className="platform-page doubts-hub-page">
        ...
        <div className="performance-stats-strip">
           <div className="performance-grid">
              <div className="performance-card">
                 ...
                 <div className="perf-value">12 <span className="perf-unit">Issues</span></div>
                 <div className="perf-trend negative">
                    <Icon name="trendUp" size={14} /> -2 since yesterday
                 </div>
              </div>
              <div className="performance-card">
            ...
            {filtered.map(t => (
              ...
              >
                <div className="ticket-avatar-status">
                  <div className={`status-icon-box ${t.status === 'Recently Solved' ? 'solved' : 'ongoing'}`}>
                    <Icon name={t.status === 'Recently Solved' ? 'checkCircle' : 'helpCircle'} size={32} stroke={2.5} />
                  </div>
                ...
                <div className="ticket-main-body">
                  <div className="ticket-row-top">
                    ...
                    <div className={`status-tag-pill ${t.status === 'Recently Solved' ? 'solved' : 'ongoing'}`}>
                  ...
                  <div className="ticket-row-footer">
                    <div className="expert-assignment">
                        <div className="assignee-avatar">{t.avatar}</div>
                        <div className="assignee-meta">
                           <span className="assignee-name" style={{ fontSize: '0.9rem', fontWeight: 900 }}>{t.replier}</span>
                           <span className="assignee-role" style={{ fontSize: '0.65rem' }}>Verified Expert</span>
                        </div>
                    </div>
                    
                    <div className="ticket-meta-pills">
                       <div className="meta-pill-item category">
                          <Icon name="tag" size={12} /> {t.category}
                       </div>
                       <div className={`meta-pill-item priority ${t.priority === 'Urgent Attention' ? 'critical' : ''}`}>
                          <Icon name="alertCircle" size={12} /> {t.priority}
                       </div>
      ...
      <style jsx global>{`
        ...
        .meta-pill-item.priority.critical { color: #ef4444; background: #fef2f2; border-color: #fee2e2; }
